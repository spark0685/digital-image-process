...
if __name__ == '__main__':
    ...
    # 保存图片
    imageio.imwrite('result_1_2\\vertical_rectangle_1.png', result1)
    imageio.imwrite('result_1_2\\shepp-logan_phantom_1.png', result2)

    image3 = transform2(image1, result1)
    image4 = transform2(image2, result2)

    # 保存结果
    imageio.imwrite('result_1_2\\vertical_rectangle_2.png', image3)
    imageio.imwrite('result_1_2\\shepp-logan_phantom_2.png', image4)
